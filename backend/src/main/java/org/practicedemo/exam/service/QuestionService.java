...
public interface QuestionService extends IService<Question> {
    ...
    /**
     * 分页查询题目列表，支持多条件筛选
     * @param pageList 分页对象，包含页码和每页大小
     * @param questionPageVo 查询条件封装对象，包含题目名称、分类ID、难度等级等筛选条件
     */
    void customPageService(Page<Question> pageList, QuestionPageVo questionPageVo);
}